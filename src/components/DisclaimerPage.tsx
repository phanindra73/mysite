...
import { AlertTriangle, BookOpen, GraduationCap, FileText, Compass, Server, Mail, ArrowLeft, Linkedin, Github, Facebook } from 'lucide-react';
...
export default function DisclaimerPage({ onNavigate }: DisclaimerPageProps) {
  return (
    <div id="disclaimer-container" className="pt-2 sm:pt-6 pb-20 bg-slate-50/50 min-h-screen text-justify">
      
      {/* Hero Header Section */}
      <div id="disclaimer-hero" className="bg-gradient-to-br from-slate-900 via-slate-950 to-red-950/20 text-white py-12 sm:py-16 text-left relative overflow-hidden">
        ...
        >
          ...
          <section className="space-y-3">
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              The information provided on this website is for general educational and informational purposes only. We request our digital and physical visitors to analyze these guidelines completely.
            </p>
          </section>
          ...
          <section className="space-y-4 border-t border-gray-100 pt-6">
            <div className="flex items-center gap-2.5 text-gray-900">
              ...
              <h2 className="text-lg sm:text-xl font-bold tracking-tight">Educational Purpose</h2>
            </div>
            <p className="text-xs sm:text-sm text-gray-650 leading-relaxed">
              The training programs, technology workshops, and customized educational modules offered by The Sun Technologies are engineered strictly to upgrade intellectual skills, technical foundations, and industrial competencies.
            </p>
          </section>
          ...
          <section className="space-y-4 border-t border-gray-100 pt-6">
            <div className="flex items-center gap-2.5 text-gray-900">
              <GraduationCap size={18} className="text-[#e41e3d] flex-shrink-0" />
              <h2 className="text-lg sm:text-xl font-bold tracking-tight">No Employment Guarantee</h2>
            </div>
            <p className="text-xs sm:text-sm text-gray-650 leading-relaxed">
              While we strive to supply world-class education, industry-aligned career roadmaps, interview prep pathways, and placement coordinates, <strong>we do not guarantee employment, designated job placement, exact salary packages, or specific career outcomes</strong>.
            </p>
            <p className="text-xs sm:text-sm text-gray-655 leading-relaxed bg-slate-50 border border-slate-100 rounded-lg p-4 font-mono">
              Individual student and candidate placement success is strictly subject to core factors including personal grit, coding skills, previous industrial experience, broader hiring market trends, and independent enterprise evaluator thresholds.
            </p>
          </section>
          ...
          <section className="space-y-3 border-t border-gray-100 pt-6">
            <div className="flex items-center gap-2.5 text-gray-900">
              ...
              <h2 className="text-lg sm:text-xl font-bold tracking-tight">Accuracy of Information</h2>
            </div>
            <p className="text-xs sm:text-sm text-gray-650 leading-relaxed">
              We apply diligent efforts to maintain accurate course metrics, corporate placement records, and platform curriculum details; nonetheless, we specify absolutely no warranties, explicit or implied, surrounding the complete timeliness, reliability, or accuracy of the serving systems.
            </p>
          </section>
          ...
          <section className="space-y-3 border-t border-gray-100 pt-6">
            <div className="flex items-center gap-2.5 text-gray-900">
              <Compass size={18} className="text-[#e41e3d] flex-shrink-0" />
              <h2 className="text-lg sm:text-xl font-bold tracking-tight">External Resources</h2>
            </div>
            <p className="text-xs sm:text-sm text-gray-650 leading-relaxed">
              Any reference or redirect path leading to outside libraries, developer tools, target technologies, or external third-party services is introduced solely for learning convenience.
            </p>
          </section>
          ...
          <section className="space-y-3 border-t border-gray-100 pt-6">
            <div className="flex items-center gap-2.5 text-gray-900">
              <AlertTriangle size={18} className="text-[#e41e3d] flex-shrink-0" />
              <h2 className="text-lg sm:text-xl font-bold tracking-tight">Limitation of Liability</h2>
            </div>
            <p className="text-xs sm:text-sm text-gray-650 leading-relaxed">
              The Sun Technologies and its managing coordinators shall assume zero administrative or legal liability for any direct, indirect, random, or subsequent loss arising out of the active use, reference, or inability to access this website, its documents, or its academic curricula.
            </p>
          </section>
      ...
      <footer id="disclaimer-footer" className="bg-slate-950 text-slate-400 py-6 mt-16 border-t border-slate-800/80">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5 text-left">
            ...
            <div>
              ...
              <ul className="space-y-1 text-xs">
                ...
                <li><button onClick={() => { onNavigate('Disclaimer'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-[#e41e3d] hover:text-[#e41e3d] transition-colors cursor-pointer text-left block font-medium">Disclaimer</button></li>
